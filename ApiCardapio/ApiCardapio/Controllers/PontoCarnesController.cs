...
namespace ApiCardapio.Controllers
{
    ...
    public class PontoCarnesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PontoCarne>>> GetPontosCarne()
        {
        ...
        public async Task<ActionResult<PontoCarne>> GetPontoCarne(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutPontoCarne(int id, PontoCarne pontoCarne)
        {
            if (id != pontoCarne.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<PontoCarne>> PostPontoCarne(PontoCarne pontoCarne)
        {
