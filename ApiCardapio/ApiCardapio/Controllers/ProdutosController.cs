...
namespace ApiCardapio.Controllers
{
    ...
    public class ProdutosController : ControllerBase
    {
        ...
        // GET: api/Produtos
        [HttpGet("recuperarProduto")]
        public async Task<ActionResult<IEnumerable<Produto>>> GetProdutos()
        {
            return await _context.Produtos.Include(f => f.Categoria).ToListAsync();
        }
        ...
        {
            var produto = await _context.Produtos.Include(f => f.ProdutoIngredientes).ThenInclude(f => f.Ingrediente)
                                                 .Include(f => f.ProdutoIngredientes)
